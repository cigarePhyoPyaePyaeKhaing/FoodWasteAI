...
public class RecommendationDao extends BaseDao {
    ...
    public List<Recommendation> findAll(Long userId) throws SQLException {
        return findActiveRecommendations(userId);
    }

    public List<Recommendation> findActiveRecommendations() throws SQLException {
        return findActiveRecommendations(null);
    }
    ...
    public int clearPendingRecommendations() throws SQLException {
        return clearPendingRecommendations(null);
    }
