...
public class InventoryServlet extends BaseServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            // Stock history endpoint: /api/inventory/{id}/history or /api/inventory?history={id}
            ...
            String expiredReview = req.getParameter("expiredReview");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        try {
            ...
            FoodItem saved = foodItemService.addFoodItem(item, userId);
            sendCreated(resp, "Food item processed successfully", saved);
