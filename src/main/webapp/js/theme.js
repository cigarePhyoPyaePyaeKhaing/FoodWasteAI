...
const ThemeManager = {
  ...
  renderThemeSelectors() {
    // 1. Dedicated Settings Page Theme Selector
    const settingsContainer = document.getElementById('settings-theme-container');
    if (settingsContainer) {
      settingsContainer.innerHTML = this.getDesktopSelectorMarkup();
    }

    // 2. Sidebar Theme Selector (if present)
    ...
    // 3. Topbar Theme Switcher (if present)
