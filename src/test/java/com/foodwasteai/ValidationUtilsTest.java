...
public class ValidationUtilsTest {
    ...
    public void testFoodItemValidation() {
        FoodItem item = new FoodItem(1L, "Chicken", "Poultry", new BigDecimal("50.0"), "kg", new BigDecimal("6500"), LocalDate.now().plusDays(2), new BigDecimal("10.0"));
        assertDoesNotThrow(() -> ValidationUtils.validateFoodItem(item));

        FoodItem negativeQtyItem = new FoodItem(2L, "Chicken", "Poultry", new BigDecimal("-5.0"), "kg", new BigDecimal("6500"), LocalDate.now(), new BigDecimal("10.0"));
        assertThrows(IllegalArgumentException.class, () -> ValidationUtils.validateFoodItem(negativeQtyItem));

        FoodItem missingExpiryItem = new FoodItem(3L, "Chicken", "Poultry", new BigDecimal("5.0"), "kg", new BigDecimal("6500"), null, new BigDecimal("10.0"));
