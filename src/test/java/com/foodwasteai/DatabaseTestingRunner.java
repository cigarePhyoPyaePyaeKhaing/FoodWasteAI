...
public class DatabaseTestingRunner {
    ...
    public void setupDatabaseAndInsertSampleData() throws Exception {
        ...
        try (Connection conn = DatabaseConfig.getConnection();
            ...
            // Ensure BCrypt password hashes for admin123 and staff123
            String adminHash = org.mindrot.jbcrypt.BCrypt.hashpw("admin123", org.mindrot.jbcrypt.BCrypt.gensalt(10));
            String staffHash = org.mindrot.jbcrypt.BCrypt.hashpw("staff123", org.mindrot.jbcrypt.BCrypt.gensalt(10));
            stmt.executeUpdate("INSERT INTO users (username, email, password_hash, full_name, role, active) VALUES " +
                    "('admin', 'manager@foodwaste.ai', '" + adminHash + "', 'Restaurant Manager (Admin)', 'ADMIN', TRUE) " +
                    "ON DUPLICATE KEY UPDATE password_hash = VALUES(password_hash), role = VALUES(role)");
            stmt.executeUpdate("INSERT INTO users (username, email, password_hash, full_name, role, active) VALUES " +
                    "('staff', 'staff@foodwaste.ai', '" + staffHash + "', 'Kitchen Staff', 'STAFF', TRUE) " +
                    "ON DUPLICATE KEY UPDATE password_hash = VALUES(password_hash), role = VALUES(role)");
            System.out.println("Schema, seed, and user credentials verified successfully.");
        }
        ...
        milk.setMinStockThreshold(new BigDecimal("10.00"));
        ...
        fish.setMinStockThreshold(new BigDecimal("5.00"));
        ...
        veg.setMinStockThreshold(new BigDecimal("10.00"));
        ...
        rice.setMinStockThreshold(new BigDecimal("20.00"));
        rice.setStatus("OK");
        ...
        chicken.setMinStockThreshold(new BigDecimal("5.00"));
